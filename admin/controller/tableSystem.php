		...
		<div class="main-grid">
			<div class="agile-grids">	
				...
				<div class="table-heading">
					<h2>Les Systems Disponible</h2>
					<a  href="ajouterSystem.html"><i class="fa fa-plus fa-2x"></i> </a>
				</div>
...
$resultat=mysqli_query($db, "select * from system;");
while ($ligne=mysqli_fetch_array($resultat)) {
    ?>
              ...
              <td>         
                <a class="text-danger" href="supprimersystem.php?id=<?php echo $ligne['id'] ?>"><i class="fa fa-trash-o fa-2x"></i></a>
                &nbsp;&nbsp;
							</td>
